      ...
      <section>
        <Article>
          <section>
            ...
            />
            <p>
              Defines a block of navigation links. Ideal for the main menu of a
              website.
            </p>
            <p className="mt-2 w-fit rounded-lg bg-zinc-700 p-2">{'<nav />'}</p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              accessibility, as it allows screen readers to quickly navigate to
              the main content.
            </p>
          ...
          <section>
            ...
            />
            <p className="mb-2">
              Represents headings in a document. Ranges from h1 (most important)
          ...
          <section>
            ...
            />
            <p>
              Defines content indirectly related to the main content, such as
              sidebars, call-out boxes, or advertisements.
            </p>
            <p className="mt-2 w-fit rounded-lg bg-zinc-700 p-2">
              {' '}
              {'<aside/>'}
          ...
          <section>
            ...
            />
            <p>
              Defines the footer of a document or section. Contains information
              like copyright, authorship, and related links.
            </p>
            <p className="mt-2 w-fit rounded-lg bg-zinc-700 p-2">
              {'<footer />'}
            </p>

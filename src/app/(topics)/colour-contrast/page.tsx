  ...
  return (
    <main>
      <section className="space-y-4 ">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>Colour contrast </AccordionTrigger>
            <AccordionContent>
              <Article>
                <p>
                  Colour contrast is the difference in brightness between the
                  text and the background. It's important to ensure that text is
                  readable by everyone, including those with visual impairments.
                </p>
                <p>
                  The Web Content Accessibility Guidelines (WCAG) recommend a
                  contrast ratio of at least 4.5:1 for normal text and 3:1 for
                  large text.
                </p>
                <p>
                  To check the contrast ratio of your text, you can use a tool
                  like{' '}
                  <a
                ...
                <p>
                  Here are some examples of text with good and bad contrast
                  ratios.
                </p>
      ...
      <section className="mt-8">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>A fun colour blind example </AccordionTrigger>
            <AccordionContent>
              <Article>
                <Image
                  src="/yoshi.png"
